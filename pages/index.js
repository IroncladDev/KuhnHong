    ...
    return (
      <div>
        ...
        <div>
          ...
          <section className={cs(cont.relcont, pos.stackGrid)} style={{ background: 'rgba(255, 225, 75, 0.25)', minHeight: '100vh', height: 'auto' }}>
          ...
          <section className={cont.relcont} style={{ background: 'black' }}>
            ...
            <div>
              <Link href="/gallery" passHref>
                <h1 className={styles.galleryLink} style={{ fontSize: '3em' }}>See my Gallery &gt;&gt;</h1>
              </Link>
